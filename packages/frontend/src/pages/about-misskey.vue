			...
			<div class="_gaps_m znqjceqz">
				<div v-panel class="about">
					<div ref="containerEl" class="container" :class="{ playing: easterEggEngine != null }">
						...
						<div class="misskey">Cat World</div>
				...
				<!-- <div style="text-align: center;">
					{{ i18n.ts._aboutMisskey.about }}<br><a href="#" target="_blank" class="_link">{{ i18n.ts.learnMore }}</a>
				</div> -->
				<div v-if="$i != null" style="text-align: center;">
					<MkButton primary rounded inline @click="iLoveMisskey">I <Mfm text="$[jelly ❤]"/> #Cat World</MkButton>
				</div>
				<!-- <FormSection>
					<div class="_gaps_s">
						<FormLink to="#" external>
				...
				<!-- <FormSection v-if="instance.repositoryUrl !== '#'">
					<div class="_gaps_s">
						<MkInfo>
				...
				<FormSection>
					...
					<div :class="$style.contributors">
						<a href="https://github.com/shangmuzhuqin" target="_blank" :class="$style.contributor">
							<img src="https://avatars.githubusercontent.com/u/23651739?v=4" :class="$style.contributorAvatar">
							<span :class="$style.contributorUsername">@shangmuzhuqin</span>
						</a>
						<a href="#" target="_blank" :class="$style.contributor">
							<img src="https://avatars.githubusercontent.com/u/23651739?v=4" :class="$style.contributorAvatar">
							<span :class="$style.contributorUsername">@shangmuzhuqin</span>
						</a>
						<a href="#" target="_blank" :class="$style.contributor">
