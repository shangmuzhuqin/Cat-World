...
-->
			<MkFolder :defaultOpen="true">
				...
				<a href="http://www.shiningcircle.com.cn/html/index.php/archives/367/" class="_link" target="_blank">{{ i18n.ts.basicNotesBeforeCreateAccount }} <i class="ti ti-external-link"></i></a>
